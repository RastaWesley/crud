...
public class DynamoDBConfig {
    ...
    public static final String ACCESS_KEY = "AKIA3FDKCMTJIYJRPNPJ";
    public static final String SECRET_KEY = "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";
